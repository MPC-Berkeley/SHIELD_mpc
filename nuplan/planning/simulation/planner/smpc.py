...
class SMPC(): 
    ...
    def _return_policy_class(self):
        ...
        if self.offline:
            #Epigraph variable for l1 regularization
    ...
    def _add_constraints_and_cost(self): 
                ...
                if self.config['collision_avoidance_method'] == 'affine':
                    ...
                    for t in range(1, self.N):
                        ...
                        for l in range(self.N_TV):
                            ...
                            tv_rand.append(term)
                        z = (base @ ca.hcat([ev_rand] + tv_rand)).T
        ...
        if self.offline: 
            ...
            if not hasattr(self, "_eta_inv"):
                ...
                self._eta_inv = 1.0 / float(eval_max)   # = 1 / eig_max(Q)
                self._sigma   = 1.0 / float(eval_min)   # = 1 / eig_min(Q)
            ...
            # Evaluate and cache as numpy and scipy once
    ...
    def solve_dual_approximation(self, Q, L, F, C, p, f, c, ca_dual, l1_dual):
        ...
        ls_tol = float(self.config.get('ls_tol', 1e-6))
